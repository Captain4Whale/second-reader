...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        "group focus-visible:ring-ring relative flex w-[7px] shrink-0 items-center justify-center bg-[var(--warm-100)] focus-visible:ring-1 focus-visible:ring-offset-1 focus-visible:outline-hidden after:absolute after:inset-y-3 after:left-1/2 after:w-px after:-translate-x-1/2 after:rounded-full after:bg-[var(--warm-300)]/60 after:transition-colors hover:after:bg-[var(--amber-accent)]/38 data-[resize-handle-state=drag]:after:bg-[var(--amber-accent)]/58 data-[panel-group-direction=vertical]:h-[7px] data-[panel-group-direction=vertical]:w-full data-[panel-group-direction=vertical]:after:inset-x-3 data-[panel-group-direction=vertical]:after:top-1/2 data-[panel-group-direction=vertical]:after:h-px data-[panel-group-direction=vertical]:after:w-auto data-[panel-group-direction=vertical]:after:-translate-y-1/2 data-[panel-group-direction=vertical]:after:translate-x-0 [&[data-panel-group-direction=vertical]>div]:rotate-90",
        className,
      )}
      {...props}
    >
