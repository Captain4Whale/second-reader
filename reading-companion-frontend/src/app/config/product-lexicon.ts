...
export const PRODUCT_LEXICON = {
  ...
  "reaction.highlight": {
    en: "Highlight",
    zh: "划线",
    definition: "Passages the reader thinks are worth carrying into the margin.",
    usageNote: "Use as the canonical label for this Marginalia type across all UI surfaces.",
  ...
  "reaction.association": {
    ...
    usageNote: "Use as the canonical label for associative Marginalia.",
  },
  "reaction.curious": {
    en: "Curious",
    zh: "好奇",
    definition: "Questions that push into missing evidence or context.",
    usageNote: "Use as the canonical label for search-seeking Marginalia.",
  },
  "reaction.discern": {
    en: "Discern",
    zh: "审辩",
    definition: "Sharper distinctions or tensions inside the claim.",
    usageNote: "Use as the canonical label for distinction-making Marginalia.",
  },
  "reaction.retrospect": {
    en: "Retrospect",
    zh: "回溯",
    definition: "Callbacks to earlier threads in the same book.",
    usageNote: "Use as the canonical label for retrospective Marginalia.",
  },
  "mark.resonance": {
    en: "Resonance",
    zh: "共鸣",
