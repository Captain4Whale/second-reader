...
export type FeaturedMarginaliaPreview = FeaturedReactionPreview;
...
export type MarginaliaCard = ReactionCard;
...
export type MarginaliaPageResponse = ApiSchemas["MarginaliaPageResponse"];
