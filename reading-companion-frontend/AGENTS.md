...
- For core application surfaces, prefer the frontend visual-system tokens over ad-hoc inline `fontSize` values.
- Treat the landing page's marketing typography as a documented exception unless the task explicitly asks for landing redesign.
...
- Follow `../docs/frontend-visual-system.md` for how interface typography differs from reader-content typography.
