...
- Shared substrate
  ...
  - Source normalization is the upstream shared-substrate responsibility for classifying original paragraph/block records into mainline, heading, auxiliary, and noise roles before one mechanism reads them. The accepted design direction lives in `docs/implementation/new-reading-mechanism/source-normalization-design.md`; it is not yet a live parser/runtime implementation.
