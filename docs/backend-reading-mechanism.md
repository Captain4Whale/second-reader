...
- Shared runtime shell
  ...
  - The verified MiniMax / DeepSeek transport matrix and current default policy live in `docs/implementation/new-reading-mechanism/llm-structured-output-protocol-note.md`.
