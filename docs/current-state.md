...
Last verified: `2026-05-17T10:34:33+08:00`
...
- Land the repo-local Memory / Planning / Evaluation design chain and implementation handoff for optimizing the existing `attentional_v2` mechanism.
  - status:
    ...
    - `Slice7B-Minimal-Eval-Smoke-Harness-and-Evidence-Availability-Validation-Pre-implementation-Brief v0.md` is pending human review
    - Slice 7B implementation has not started, and no eval, judge calls, benchmark jobs, or reading jobs have been run for Slice 7B
  ...
  - next step:
    - human reviewer should review and accept `Slice7B-Minimal-Eval-Smoke-Harness-and-Evidence-Availability-Validation-Pre-implementation-Brief v0.md` or request revision
    - do not start Slice 7B implementation or any eval run before the Slice 7B Pre-implementation Brief is accepted
  - current non-goals:
