...
| `attentional_v2` | `design-only` | not default | `docs/backend-reading-mechanisms/attentional_v2.md` | `_mechanisms/attentional_v2/` | future attention-frontier design with scaffolded runtime, survey, intake, and Phase 4 interpretive-node artifacts |
