...
- Subject continuity is implemented in Digest prompt `attentional_v2.digest.v12` and documented in `docs/implementation/new-reading-mechanism/ingest-recall-and-digest-memory-context-design.md`.
