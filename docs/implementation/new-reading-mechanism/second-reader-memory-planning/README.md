...
| `codex/reports/Slice8H-Diagnostic-Evidence-Catalog-Entry-for-Minimal-Eval-Suite-Smoke-Post-implementation-Report v0.md` | post-implementation report | Slice 8H diagnostic smoke evidence catalog entry report | pending human review; not stable behavior authority |
