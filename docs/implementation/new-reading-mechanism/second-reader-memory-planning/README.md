...
| `codex/reports/Slice8F-Lane-B-Bounded-Diagnostic-Smoke-Post-run-Report v0.md` | post-run report | Slice 8F Lane B bounded diagnostic smoke evidence and review gate | pending human review; not stable behavior authority |
