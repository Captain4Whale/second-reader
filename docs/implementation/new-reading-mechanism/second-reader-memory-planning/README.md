...
| `codex/briefs/Slice8C-Minimal-Eval-Suite-Execution-Preflight-and-Bounded-Run-Pre-implementation-Brief v0.md` | pre-implementation brief | Slice 8C minimal eval suite execution preflight and bounded run brief | pending human review |
