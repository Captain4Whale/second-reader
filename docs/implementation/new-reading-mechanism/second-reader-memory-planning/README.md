...
| `codex/briefs/Slice7A-Minimal-Eval-Asset-Inventory-and-Evidence-Wiring-Pre-implementation-Brief v0.md` | pre-implementation brief | Slice 7A minimal eval asset inventory and evidence wiring brief | pending human review |
