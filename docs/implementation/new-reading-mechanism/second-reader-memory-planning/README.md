...
| `codex/briefs/Slice8B-Minimal-Eval-Suite-Run-Brief-and-Execution-Guardrails-Pre-implementation-Brief v0.md` | pre-implementation brief | Slice 8B minimal eval suite run brief and execution guardrails | pending human review |
