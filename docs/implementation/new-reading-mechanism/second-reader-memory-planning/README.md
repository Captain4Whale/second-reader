...
| `codex/briefs/Slice7B-Minimal-Eval-Smoke-Harness-and-Evidence-Availability-Validation-Pre-implementation-Brief v0.md` | pre-implementation brief | Slice 7B minimal eval smoke harness and evidence availability validation brief | pending human review |
