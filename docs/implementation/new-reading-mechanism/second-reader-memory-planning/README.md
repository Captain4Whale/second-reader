...
| `codex/reports/Slice8G-Minimal-Eval-Suite-Smoke-Closure-and-Evidence-Interpretation-Report v0.md` | closure report | Slice 8G Minimal Eval Suite smoke closure and evidence interpretation report | pending human review; not stable behavior authority |
