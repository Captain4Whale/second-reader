...
| `codex/reports/Slice8A-Post-implementation-Review-and-Minimal-Eval-Readiness-Gate-Post-implementation-Report v0.md` | post-implementation report | Slice 8A readiness-gate evidence and review gate | pending human review; not stable behavior authority |
