...
| `codex/reports/Slice8E-Lane-A-Retry1-Bounded-Execution-Post-run-Report v0.md` | post-run report | Slice 8E Lane A `_retry1` bounded execution evidence and review gate | pending human review; not stable behavior authority |
