...
| `codex/briefs/Slice6A-Slow-cycle-Candidate-and-Settlement-Audit-Envelope-Foundations-Pre-implementation-Brief v0.md` | pre-implementation brief | Slice 6A slow-cycle candidate and settlement audit envelope foundations brief | pending human review |
