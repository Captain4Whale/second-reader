...
INGEST_PROMPT_VERSION = "attentional_v2.ingest.v8"
INGEST_XML_PROMPT_ASSEMBLY_SPEC_ID = "attentional_v2.ingest.xml.v8"
INGEST_XML_PROMPTSET_VERSION = "attentional_v2-phase6-v58"
