...
DIGEST_PROMPT_VERSION = "attentional_v2.digest.v4"
DIGEST_XML_PROMPT_ASSEMBLY_SPEC_ID = "attentional_v2.digest.xml.v4"
DIGEST_XML_PROMPTSET_VERSION = "attentional_v2-phase6-v49"
