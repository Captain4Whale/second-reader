# Dataset Review Packet `attentional_v2_reviewed_slice_expansion_round1_en`
...
5. Tell Codex that packet `attentional_v2_reviewed_slice_expansion_round1_en` is ready.
