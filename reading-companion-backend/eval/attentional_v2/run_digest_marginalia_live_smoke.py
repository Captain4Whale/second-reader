#!/usr/bin/env python3
"""Run a small live smoke for Digest v17 Marginalia.
...
DEFAULT_RUN_ID = "digest_marginalia_v17_live_smoke_20260621"
DEFAULT_ANALYSIS_ID = "digest_marginalia_v17_live_smoke"
DEFAULT_JOB_ID = "bgjob_digest_marginalia_v17_live_smoke_20260621"
...
def _hard_failures(direct_results: list[dict[str, object]], runner_results: list[dict[str, object]]) -> list[str]:
    ...
    if prompt.digest_version != "attentional_v2.digest.v17":
        failures.append(f"unexpected_digest_version:{prompt.digest_version}")
    if prompt.promptset_version != "attentional_v2-phase6-v77":
