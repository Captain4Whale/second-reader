#!/usr/bin/env python3
"""Run a small live smoke for Digest v12 Marginalia.
...
DEFAULT_RUN_ID = "digest_marginalia_v12_live_smoke_20260621"
DEFAULT_ANALYSIS_ID = "digest_marginalia_v12_live_smoke"
DEFAULT_JOB_ID = "bgjob_digest_marginalia_v12_live_smoke_20260621"
    ...
    *,
    ...
    for probe in DIRECT_PROBES:
        ...
        trace_context = eval_trace_context(
            analysis_root,
            eval_target="digest_marginalia_v12_live_smoke",
            stage="direct_digest",
            node=probe.probe_id,
...
def _hard_failures(direct_results: list[dict[str, object]], runner_results: list[dict[str, object]]) -> list[str]:
    ...
    if prompt.digest_version != "attentional_v2.digest.v12":
        failures.append(f"unexpected_digest_version:{prompt.digest_version}")
    if prompt.promptset_version != "attentional_v2-phase6-v70":
...
def render_report(
    *,
    ...
    lines: list[str] = [
        "# Digest Marginalia v12 Live Smoke",
        "",
        "## Summary",
