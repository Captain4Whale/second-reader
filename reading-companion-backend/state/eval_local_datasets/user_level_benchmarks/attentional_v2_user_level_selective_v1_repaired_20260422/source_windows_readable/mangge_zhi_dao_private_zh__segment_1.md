# Source Window: 芒格之道：查理·芒格股东会讲话 1987—2022

- segment_id: `mangge_zhi_dao_private_zh__segment_1`
- source_id: `mangge_zhi_dao_private_zh`
- author: `[美]查理·芒格`
- language_track: `zh`
- covered chapters: `1987年 西科金融股东会讲话, 1988年 西科金融股东会讲话, 1989年 西科金融股东会讲话, 1990年 西科金融股东会讲话`
- source sentence range: `c4-s1` - `c7-s459`
- note target count in dataset window: `25`
- raw source file: `../segment_sources/mangge_zhi_dao_private_zh__segment_1.txt`
...
| ---: | --- | --- | --- | ---: | --- |
| 1 | near 20% | annual chapter close | `c1-s411` / `c1-s411` | 179 | 1988 annual discussion closure<br>management trust and reputation<br>valuation discipline before the 1989 shift |
| 2 | near 40% | major argument turn | `c1-s710` / `c1-s710` | 271 | anti-forecasting investment posture<br>cash optionality<br>disclosure boundary and Mutual Savings transition |
| 3 | near 60% | crisis appendix argument turn | `c1-s1052` / `c1-s1053` | 396 | S&L crisis mechanics<br>regulatory incentives and unintended consequences<br>causal explanation before normative judgment |
| 4 | near 80% | section close | `c1-s1418` / `c1-s1418` | 551 | 1990 crisis recap<br>regulator exhaustion<br>transition from crisis diagnosis to investing doctrine |
| 5 | window end | window end | `c1-s1755` / `c1-s1755` | 652 | full-window investment doctrine continuity<br>crisis-to-risk-arbitrage arc<br>Munger/Buffett operating principles across the window |
...
- `mangge_zhi_dao_private_zh_personal_notes__e0001` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0001` / `p70@0-30`
  - target note: 这证明，一家公司建立了好的文化之后，就能走上良性循环的轨道。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0002` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0002` / `p81@0-23`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0003` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0003` / `p82@0-102`
  - target note: 用“谦卑”这个词也许不太恰当，可能用“务实”这个词更合适。我们能取得今时今日的成就，不是因为我们的能力比别人高出多少，而是我们比别人更清楚自己能力的大小。清楚自己能力的大小，这个品质应该不能说是“谦卑”。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0004` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0004` / `p83@62-99`
  - target note: 一件事，他没彻底弄明白之前，是绝对不会做的。一笔交易，等上五年，他都能等。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0005` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0005` / `p85@0-73`
  - target note: 充分认清客观条件的限制，充分认识自身能力的限制，谨小慎微地在限制范围内活动，这是赚钱的诀窍。这个诀窍，与其说是“谦卑”，不如说是“有克制的贪婪”。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0006` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0006` / `p99@0-81`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0006` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0006` / `p100@0-22`
  - target note: 多年以前，我在帕萨迪纳市有个朋友，是做渔具生意的。他出售的鱼钩五颜六色的。我以前从没见过色彩这么丰富的鱼钩。我问他：“你这鱼钩五颜六色的，鱼是不是更容易上钩啊？”他回答道：“查理，我这鱼钩又不是卖给鱼的。”
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0007` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0007` / `p101@16-62`
...
```text
作为美国排名前三的投资银行、做市商和承销商，所罗门兄弟公司（Salomon Brothers）[3]的生意怎么能不是好生意呢？
```
...
- Probe `1` / `near 20%` / capture `c1-s411`
  - focus: Closes the 1988 discussion before the 1989 turn, giving a semantically complete checkpoint for the early management-trust and valuation discipline material.
...
```text
[3] 1987年，伯克希尔以七亿美元买进所罗门兄弟公司20%的优先股，其中的一亿美元由西科及其子公司投资。沃伦和查理当选为所罗门的董事。
```

### p184

```text
[4] 多年前，西科卖掉了分支机构的办公室。芒格认为金融公司开设分支机构的做法已经过时了。
```
...
```text
我完成股东会正式流程的速度很快[5]，但还是没有路易斯·韦森特（Louis Vicente）的速度快。韦森特已经去世了，他曾经担任西科董事会主席很多年。他的夫人珍·韦森特是我们的老股东，今天也来到了这里。
```
...
```text
西科在圣巴巴拉市（Santa Barbara）做这个地产项目饱受折磨，好在终于要修成正果了。[6]
```
...
```text
与劳合社相比，消防员基金保险公司的经营管理更胜一筹。尽管如此，消防员基金保险公司也同样承受着商业财产保险行业中令人窒息的竞争压力。业绩规模是用了近百年时间才积累起来的，负责核保、理赔的众多员工和你共事多年，都是非常熟悉的老同事了，怎么可能轻而易举地说：“算了，保费低到没法做了，我们要把规模削减80%。”伯克希尔·哈撒韦已经在保险业务上采取了大规模收缩的策略。[7]
```
...
```text
我预计加州最高法院将以五票反对、两票赞成的结果，宣布“103号提案”降低保费20%的要求不符合宪法精神。降低保费20%的要求太过分了，不符合传统法律文化，应该被驳回。无论如何，人身保险公司的苦日子也要来了。[8]
```
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0008` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0008` / `p255@122-216`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0009` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0009` / `p258@104-187`
  - target note: 威廉·奥斯勒爵士信奉托马斯·卡莱尔(Thomas Carlyle)的一句名言：“与其为朦胧的未来而烦恼忧虑，不如脚踏实地，做好眼前的事。”这同样是伯克希尔的经营哲学。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0010` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0010` / `p259@90-157`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0011` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0011` / `p260@127-223`
  - target note: 。在我们的世界观中，我们不相信预言。我们不是纯粹的机会主义者，但我们确实信奉见机行事。我们也做长期预测，但做得很少。也许正是因为我们努力做好眼前的事，很少做长期预测，我们的长期预测才更加准确。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0012` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0012` / `p268@0-33`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0012` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0012` / `p269@0-38`
  - target note: 最后，还有一类人，愚蠢而又勤奋。按照陆军操典所说，此类人必须遣散。我们深有同感。一类是品行不端的人，一类是愚蠢而又勤奋的人，这两类人都是祸害。
...
Long Span probe markers near this paragraph:
- Probe `2` / `near 40%` / capture `c1-s710`
  - focus: Ends the anti-forecasting and cash-optionality argument before the Mutual Savings topic expands the 1989 material.
...
```text
最重要的是，我在年报中也详细讲了，政府为了整顿储贷行业而推出的新举措，虽说聊胜于无，但完全没有力度。要解决储贷行业的沉疴痼疾，这么轻描淡写的政策远远不够。本以为监管部门走上了正路，结果他们却退缩了。新的立法通过后，必将造成众多负面影响。[9]
```
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0013` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0013` / `p307@0-62`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0014` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0014` / `p308@48-80`
  - target note: 每当年轻人建议他冒险的时候，他总是说：“河里淹死的都是会水的。”
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0015` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0015` / `p310@100-112`
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0016` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0016` / `p361@92-152`
  - target note: 所有持有联邦牌照的储贷机构和绝大部分持有州政府牌照的储贷机构都是“互助”机构。此类机构由储户所有，不以追求股东利益为目的
...
Long Span probe markers near this paragraph:
- Probe `3` / `near 60%` / capture `c1-s1053`
  - focus: Completes the causal explanation of policy changes in the S&L crisis before the text moves into broader judgment.
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0017` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0017` / `p478@57-87`
  - target note: “变化总在发生，你不去迎接进步的变化，就会等到退步的变化”。
...
```text
联盟没有因为自己过去的游说行为导致了如此之大的危机而认识到自己的错误，反而继续一意孤行，要求维持宽松的会计政策，要求保持低于充足率的资本金，让众多储贷机构继续存在漏洞。储贷危机发生之后，联盟的所作所为无异于在“瓦迪兹”号（Valdez）漏油事件[10]发生后，埃克森公司仍然允许油轮船长随意饮酒。
```
...
```text
有很多人认为，行业协会就应该像美国储蓄机构联盟这样，为行业争取利益，没必要遵守什么道德准则。在他们看来，每个行业协会，都只有一个目的：通过鼓动如簧之舌和提供政治献金，游说立法机构，与其他行业协会竞争，为自己的行业争取利益。至于在犯下大错后，如实公开真相、真诚表达歉意，这根本不是行业协会的分内之事。各个行业协会背后，在各个国会选区，都有观点鲜明和财力雄厚的选民的支持，因此行业协会凝聚了强大的影响力。如果行业协会只顾一己之私利，那么它们的影响力是国家的心腹大患。储贷行业的危机就是前车之鉴。黑袜丑闻（Black Sox Scandal）[11]之后，美国职业棒球大联盟进行了彻底的改革。美国储蓄机构联盟也应从公众利益出发，改弦易辙。即使从成员机构的利益考虑，联盟也应该改过自新。在过去，联盟盲目追求眼前利益，酿成了行业危机，导致成员机构深陷困局。如今，联盟继续盲目追求眼前利益，将来成员机构仍将受到伤害。
```
...
```text
[5] 西科的股东会和伯克希尔·哈撒韦的股东会一样，正式流程都很快就进行完了。芒格只用了五分钟左右就完成了西科股东会的正式流程。
```

### p501

```text
[6] 西科金融有一块土地，是因无法收回贷款而没收得来的。这块土地位于海边，是西科的一项主要资产。关于这块土地，芒格在今年的西科股东信中写了以下内容：“我们因无法收回贷款而没收了一片土地，这片土地有九万平方米，位于圣巴巴拉市，紧邻海岸线。我们持有这片土地很多年了，它的实际价值已经远远超出了资产负债表上540万美元的账面价值。受到土地使用法律法规的制约，我们必须充分考虑当地居民的利益，遵守监管部门提出的诸多规定。因此，这片土地的开发拖了13年之久。皇天不负有心人，我们终于实现了水通、电通、路通和场地平整，正式的建筑工作已经展开。我们将建造32栋房屋。无论是开阔气派的空间，还是别具一格的景观，整个项目在方方面面都堪称一流。”
```

### p502

```text
[7] 伯克希尔·哈撒韦收缩了保险业务的规模，但没有裁员。伯克希尔收缩起来很容易，因为伯克希尔本来在保险业务中配备的员工人数就非常精简。
```

### p503

```text
[8] 后来，加州最高法院以全票赞同通过了“103号提案”，但是删除了其中绝大多数关于降低保费的内容。
```

### p504

```text
[9] 股东会召开后不久，西科愤然退出了储蓄和贷款行业的游说组织美国储蓄机构联盟（U.S.League of Savings Institutions），芒格所书的辞信全文见附录。
```

### p505

```text
[10] 1989年3月24日，埃克森公司的一艘巨型油轮在美加交界的阿拉斯加州威廉王子湾附近触礁，原油泄出达800多万加仑，造成极大的环境破坏。事故因油轮船长饮酒昏睡、擅自离岗而造成。
```

### p506

```text
[11] 1919年美国棒球世界大赛中，芝加哥白袜队的球员被赌博庄家收买，故意打假球输掉比赛。“黑袜”即是对白袜队的嘲讽。
```
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0018` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0018` / `p524@96-143`
  - target note: 。重压之下，它们很容易铤而走险，追求不切实际的高收益投资。最终的结局，必然是整个行业分崩离析。
...
Long Span probe markers near this paragraph:
- Probe `4` / `near 80%` / capture `c1-s1418`
  - focus: Closes the 1990 S&L crisis section before the text shifts toward Graham and risk-arbitrage lessons.
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0019` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0019` / `p561@33-77`
  - target note: 我觉得，他是想让我们知道：如果比你聪明很多的人要骗你，你再怎么判断和分析，也很难不受骗。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0020` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0020` / `p564@33-122`
  - target note: 另外，我们很清楚自己的不足，很清楚有很多事我们做不到，所以我们谨小慎微地留在我们的“能力圈”之中。“能力圈”是沃伦提出的概念。沃伦和我都认为，我们的“能力圈”是一个非常小的圆圈。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0021` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0021` / `p578@0-72`
  - target note: 本·富兰克林说过：“结婚之前，擦亮双眼。结婚之后，睁一只眼闭一只眼。”商学院就是这么做的。它们已经嫁给了大公司，有些事情，只能睁一只眼闭一只眼。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0022` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0022` / `p581@0-65`
  - target note: 本·格雷厄姆讲过，高等级公司债往往不值得投资。高等级公司债的收益率只比国债收益率略高一些，向上的潜力丝毫没有，向下的风险却特别大。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0023` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0023` / `p595@0-87`
  - target note: 无论是在我们的储贷业务，还是圣巴巴拉市的房地产业务，我们都留有充裕的安全边际。想让我们出现巨大亏损，没那么容易。除非整个社会都遭了大灾，人们都活不下去了，那我们才会陷入困境。
- `mangge_zhi_dao_private_zh_personal_notes__e0024` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0024` / `p595@0-87`
  - target note: 无论是在我们的储贷业务，还是圣巴巴拉市的房地产业务，我们都留有充裕的安全边际。想让我们出现巨大亏损，没那么容易。除非整个社会都遭了大灾，人们都活不下去了，那我们才会陷入困境。
...
Selective Legibility note targets in this paragraph:
- `mangge_zhi_dao_private_zh_personal_notes__e0025` / `mangge_zhi_dao_private_zh__mangge_zhi_dao_private_zh_personal_notes__e0025` / `p607@36-134`
...
```text
货币市场基金和当年的储贷机构没什么不同，要赚尽最后一个铜板，无非是想把业绩做得漂亮，虚增资产，管理层好从中分一杯羹。为了中饱私囊，管理层有美化业绩的冲动，自然想方设法把钱赚尽。太尽了，早晚有崩的一天，就像洛马普里塔（Loma Prieta）[12]突然爆发了大地震。
```
...
```text
我们在西科的年报里讲过，我们的生意不是能躺着赚钱的，储贷生意很难做。西科不是迷你版的伯克希尔。在防范亏损方面，西科和伯克希尔一样，丝毫不敢大意。在资产质量方面，在生意的质地方面，与伯克希尔相比，西科望尘莫及。西科的底子很薄。[13]
```
...
```text
例如，最近我们买了一些可转换优先股，预期收益率就很一般，只是比市政债和国债强一些。买大公司的可转换优先股，买的时候，我们就没指望能赚什么大钱。[14]
```
...
```text
[12] 1989年，美国加州的洛马普里塔发生了7.1级大地震，造成约62人死亡，超过3700人受伤。
```

### p651

```text
[13] 在1989年的西科股东信中，芒格谈到了西科的问题：
```

### p652

Long Span probe markers near this paragraph:
- Probe `5` / `window end` / capture `c1-s1755`
  - focus: Ends the active window, allowing the final snapshot to cover the full selected annual-letter span.
