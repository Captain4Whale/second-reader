...
- source sentence range: `c3-s1` - `c14-s132`
- note target count in dataset window: `20`
- raw source file: `../segment_sources/xidaduo_private_zh__segment_1.txt`
...
| ---: | --- | --- | --- | ---: | --- |
| 1 | near 20% | chapter close | `c1-s436` / `c1-s442` | 108 | initial dissatisfaction<br>ascetic self-denial and Samana path<br>failure of escape-through-self-erasure before Buddha encounter |
| 2 | near 30% | part-one close | `c1-s752` / `c1-s752` | 178 | teacher refusal<br>self-experience over doctrine<br>leaving inherited teachings |
| 3 | near 60% | worldly-life collapse | `c1-s1532` / `c1-s1532` | 335 | Kamala and Kamaswami worldly life<br>disgust, despair, and collapse of worldly pursuit<br>transition toward river rebirth |
| 4 | near 85% | chapter close | `c1-s2067` / `c1-s2067` | 428 | river and Vasudeva listening<br>Kamala death<br>son emergence and fatherhood transition |
| 5 | window end | window end | `c1-s2417` / `c1-s2417` | 497 | 唵 and final integration<br>river voices and unity<br>reconciliation and final transmission |
...
```text
[4]Rig-Veda，颂神诗集。“梨俱”意为诗节。印度上古时代称为吠陀时代。“吠陀”也意为“知识”“启示”。吠陀本集约产生于公元前15世纪至公元前10世纪，共分《梨俱吠陀》《娑摩吠陀》《夜柔吠陀》和《阿达婆吠陀》四部。
```
...
```text
[7]Upanishad，古印度哲学典籍。这一名称的原意是“坐在某人身旁”，蕴含“密传”之意。
```

### p65

```text
[8]Chandogya-Upanishad，奥义书之一种。散文体。产生于约公元前七八世纪至前五六世纪。
```

### p66

```text
[9]Brahman，在奥义书中指称至高存在或至高自我，即宇宙自我。
```

### p67

```text
[10]本句参《奥义书》（黄宝生译。商务印书馆，2014年10月第二版。）之《歌者奥义书》(8.3.4-5）：“……这是自我。它不死，无畏，它是梵(Brahman)。这个梵，名为真实。……知道这样，他就能天天前往天国世界。”
```

### p68

```text
[11]Samana，原为古印度宗教名词，泛指所有出家、修行、苦行、禁欲，以乞食为生的宗教人士，后为佛教所吸收，成为佛教男性出家众(比丘)的代名词，意义略同于和尚。
```
...
- Probe `1` / `near 20%` / capture `c1-s442`
  - focus: Ends the 沙门 chapter before 乔达摩, closing Siddhartha's ascetic self-denial phase and its limits.
...
- `xidaduo_private_zh_personal_notes__e0001` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0001` / `p143@0-55`
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0002` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0002` / `p165@1-95`
...
```text
[2]Hain Jetavana，佛陀宣法的著名遗迹，位于尼泊尔南境，是佛教史上最具传奇色彩的圣地。据说佛陀在这里度过了二十四个雨季。
```
...
Long Span probe markers near this paragraph:
- Probe `2` / `near 30%` / capture `c1-s752`
  - focus: Ends the first major movement through 乔达摩 and 觉醒, where Siddhartha refuses borrowed doctrine and turns toward self-experience.
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0003` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0003` / `p181@93-131`
  - target note: 可我哪，我这个有意研读世界之书、自我存在之书的人，却预先爱上一个臆想的意义。
...
```text
[1]Atharva-Veda ，吠陀本集之一，为巫术、咒语之汇集。计收赞歌七百三十一首，主要为祈福禳灾的咒法与巫术，亦包含若干哲学与科学之思想。Atharva ，“阿达婆”或系传授此种吠陀的婆罗门家族之名字。
```
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0004` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0004` / `p274@42-120`
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0005` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0005` / `p311@140-170`
  - target note: 而迦摩罗则教会他，不付出情欲就难收获情欲这一《爱经》的根本。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0006` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0006` / `p317@89-149`
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0007` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0007` / `p320@240-303`
  - target note: 他给出建议，表示同情，慷慨解囊，他甚至故意被欺骗。就像当年他热衷于侍奉诸神和做沙门时一样，他全神贯注，激情饱满地和众人游戏着。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0008` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0008` / `p330@1-74`
...
Long Span probe markers near this paragraph:
- Probe `3` / `near 60%` / capture `c1-s1532`
  - focus: Ends 轮回 before 在河边, closing Kamala/Kamaswami/worldly life and the crisis that prepares river rebirth.
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0009` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0009` / `p392@272-311`
  - target note: 为重新成为孩子，为从头再来，我必须变蠢、习恶、犯错。必须经历厌恶、失望、痛苦。
...
Long Span probe markers near this paragraph:
- Probe `4` / `near 85%` / capture `c1-s2067`
  - focus: Ends 船夫 before 儿子, after the river/Vasudeva listening frame and Kamala's death introduce fatherhood.
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0010` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0010` / `p436@89-110`
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0011` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0011` / `p484@74-103`
  - target note: 心硬又傲慢的人会受很多苦，会迷路，会做错事，会担许多罪孽。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0012` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0012` / `p490@161-189`
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0013` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0013` / `p493@93-120`
  - target note: 他从未忘形地热恋一个人。从未全然忘我地去为了爱做蠢事。
- `xidaduo_private_zh_personal_notes__e0014` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0014` / `p493@145-187`
  - target note: 可是自从儿子出现，他悉达多却成了完全的世人。苦恋着，在爱中迷失；因为爱，而成为愚人。
...
Long Span probe markers near this paragraph:
- Probe `5` / `window end` / capture `c1-s2417`
  - focus: Ends the full active window at the final integration, where the river voices, unity, reconciliation, and final transmission come together.
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0015` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0015` / `p509@49-90`
  - target note: 他忧伤地席地坐下，感到内心的一些东西正在死去。他感到虚无，看不到快乐，也没有目标。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0016` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0016` / `p514@287-351`
  - target note: 他在他们的每种激情、每种作为中看到生命、生机，看到坚不可摧之物和梵天。他在他们盲目的忠诚、盲目的强悍和坚韧中看到可爱和可敬之处。
- `xidaduo_private_zh_personal_notes__e0017` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0017` / `p514@396-441`
  - target note: 悉达多甚至怀疑自觉的价值被高估，或许它只是思想者的天真。思想者只是思想的孩童般的世人而已。
- `xidaduo_private_zh_personal_notes__e0018` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0018` / `p514@469-493`
  - target note: 就如同动物在必要时强劲决绝的作为，往往胜于人类。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0019` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0019` / `p521@71-126`
  - target note: 他坦白最狼狈的事，无所顾忌地暴露伤口。他说他今天如何被灼痛击败，孩子气地逃过河，非进城不可，河水又如何嘲笑他。
...
Selective Legibility note targets in this paragraph:
- `xidaduo_private_zh_personal_notes__e0020` / `xidaduo_private_zh__xidaduo_private_zh_personal_notes__e0020` / `p525@92-109`
