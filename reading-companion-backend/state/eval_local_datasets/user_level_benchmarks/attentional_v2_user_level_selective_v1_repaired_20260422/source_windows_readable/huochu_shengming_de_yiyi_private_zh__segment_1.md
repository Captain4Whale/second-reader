...
- source sentence range: `c8-s1` - `c8-s1295`
- note target count in dataset window: `40`
- raw source file: `../segment_sources/huochu_shengming_de_yiyi_private_zh__segment_1.txt`

## Chapter Directory

- 第一部分　在集中营的经历

## Long Span Probe Markers

Probe paragraph positions below are reviewer-orientation markers derived from the recorded probe sentence ordinal. The authoritative probe ids and capture ids remain in the run artifacts.

| Probe | Rough position | Boundary | Target/capture | Approx paragraph | Structural signals |
| ---: | --- | --- | --- | ---: | --- |
| 1 | near 20% | phase transition | `c1-s261` / `c1-s269` | 52 | 囚徒精神反应三阶段：收容阶段、适应阶段、释放与解放阶段<br>第一阶段向第二阶段过渡<br>恐惧、休克、情感麻木作为集中营心理反应框架 |
| 2 | near 40% | inner-life episode closure | `c1-s528` / `c1-s528` | 108 | 爱与妻子的形象作为精神生存资源<br>自然与美感在极端处境中的支撑作用<br>从外部苦难转向内在自由的主线 |
| 3 | near 60% | moral-decision episode closure | `c1-s794` / `c1-s794` | 149 | 被囚禁处境中的主动选择<br>照顾病友与责任感<br>命运、选择和平静之间的关系 |
| 4 | near 80% | argument turn | `c1-s1059` / `c1-s1083` | 193 | 未来感、希望和生命力的关系<br>精神状态影响身体抵抗力<br>尼采命题和意义治疗主线的准备 |
| 5 | window end | main-text ending | `c1-s1292` / `c1-s1292` | 230 | 释放与解放阶段<br>人格恢复、苦涩和幻灭<br>最终自由与不再畏惧的结尾框架 |

## Full Source Window With Dataset Markers

Paragraph numbers use `segment_source_v1` coordinates. Note target markers show dataset note spans; probe markers show approximate probe/capture locations for reviewer navigation.
...
```text
首先申明，这并不是对某些事实的陈述，而是有关我个人经历的记录，同时也是对数以百万的囚徒经历过的事件的记录。这是由一名集中营的幸存者亲口讲述的故事。故事的焦点不是大家常听到的有关集中营的恐怖遭遇，而是一些小的磨难。换句话说，就是想要回答一个问题：集中营的日常生活是如何反映在普通囚徒的思想中的？
```
...
```text
如前所述，挑选囚头是个被动的过程。只有最残忍的囚徒才能被选中 （当然也有一些让人高兴的例外）。但除了党卫军的被动选择外，囚犯当中还有一种自主选择囚头的过程。一般来说，只有那些经历过集中营的数次转移、在生存斗争中已经无所顾忌的人才能活下来。为了生存，他们可以使用一切手段，诸如人格，甚至还有暴力、偷窃和出卖朋友。我们这种人之所以能够存活，纯属幸运和上天的庇佑——不管你怎么说——我们当中最优秀的却没有我们这么幸运。
```

### p10

```text
有关集中营的真实情况在各种档案和卷宗中随处可见。在这本书中，这种真实情况只是与某个人有直接关系时才具有意义。这些真实的经历正是本文所有叙述的重点。对于曾经的集中营囚徒来说，本书想要尝试用今天的视角来解释过去的那段经历。对于未曾经历集中营囚徒生活的人来说，本书将有助于他们全面了解，最重要的是理解为数不多的幸存者的经历，进而意识到他们今天所面临的艰辛生活。这些幸存者常说：“我们不喜欢谈论我们的过去。对于经历过这场噩梦的人来说，所有的解释都是多余的，而对于没有这种经历的人来说，他们不会理解我们过去的感受，也不会理解我们现在的感觉。”
```

### p11

```text
要用心理学所要求的某种严格方法来对这样的主题进行解释和陈述是有一定难度的。但如果这个旁观者本身就是囚徒，他还会具有客观性吗？旁观者可能具有客观性，但这并不意味着他一定能够做出有价值的判断。只有亲身经历过这一切的人才会知道这种价值所在。其价值判断有可能不是那么客观；其评价也有可能不那么公正。这都是不可避免的。试图完全摒弃所有的个人偏见，正是此类著作面临的难题。有时在提及自己过去的经历时，人们是需要一定勇气的。在创作这部作品时，我曾想过匿名发表，用我在狱中的号码来代替姓名。但在作品完成后，我突然意识到，如果匿名出版，这部作品的价值将大打折扣，我必须鼓起勇气署名公开发表。因此，我没有删减任何内容，尽管我本人并没有什么表现癖。
```

### p12

```text
我没有从书中提炼出任何纯粹的理论，如果有人愿意，可以尝试。这样做可能会大大丰富囚犯心理学。这种始于一战之后的心理学研究让我们知道了 “铁丝网综合症”。我们还要感谢二战，它丰富了 “大众心理学”的知识 （如果有必要，我可以引用由勒布朗创作的众所周知的短语和书名），因为战争引发了神经之战，战争给了我集中营。
```

### p13

```text
这个故事记录了我作为一名普通囚徒的经历。首先，我要自豪地强调一点：除最后几周以外，我在集中营里没有当过精神病医生，甚至连医生也没做过。我的几名同行却很幸运地受雇到急救站工作，尽管这些破败的急救站只能提供碎纸做的绷带，但这种轻松的工作还是令人羡慕。而收监号码为119104的我，大部分时间只能干挖铁路、铺轨道这样的重体力活。例如，有一回，我的工作就是独自挖一条大路上的排水管道。好在这样的工作是有报酬的。1944年圣诞节前夕，有人送我一份所谓 “奖赏券”的礼物。这是建筑公司专为我们这些卖身当奴隶的人发行的：公司向集中营当局支付以每人每天为单位的固定报酬。每张奖券实际相当于50芬尼，通常在几周后，一张奖券可换取六支香烟，尽管有时会失效。手头有12支香烟，我的自豪感便油然而生。但更重要的是，这些香烟还可以换取12份汤，这些汤足以暂时抵挡饥饿。
```

### p14

Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0002` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0002` / `p14@110-155`
...
```text
晚上，我们了解到那位军官指指点点背后的一些重要知识。这次是我们遇到的第一次挑选，也是生死攸关的判决。经过这次判决，在这批被转移的人中，大约90%的人要走向死亡。死亡判决是在进入站台后的几个小时之内就执行生效的。分到左边的那些人将从站台直接行进到焚烧室。在焚烧室干活的一名工友告诉我，焚烧室的门上用几种欧洲文字写着 “澡堂”二字。每个囚徒进去时手里都拿着一块香皂。谢天谢地，我不用描述随后发生的事件了吧。最后的结果可想而之，许多书中都描述了这一恐怖的过程。
```

### p25

```text
晚上，我们这批活下来的少数人才听到这个噩耗。我向待在那里时间较长的囚徒询问我的同事和朋友P被送到哪里了。
```
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0003` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0003` / `p46@51-78`
...
```text
我记得莱辛曾经说过：“有些东西能使你失去理智或变得一无所有，直到再也没有什么可以失去。”一种对于非正常情境的反常反应却可以被视为正常。甚至我们精神病学家还希望，人们在非正常情形下的反应与其正常状态相比是偏向非正常的。例如在收容所等环境里，以及那些被关进集中营的人，他们所表现出来的那种非正常的思维状态。但从客观上来讲，在这种受到限定的环境下产生这些非正常的反应都是正常的。正如我描述过的，这些反应将在几天内发生变化。囚徒开始从心理反应的第一阶段进入第二阶段，即一个表现相当冷漠的阶段。在这期间，他的情感进入一种死亡状态。
```

### p52

Long Span probe markers near this paragraph:
- Probe `1` / `near 20%` / capture `c1-s269`
  - focus: Ends the first-stage camp-arrival arc and crosses into the second stage, so the snapshot can be checked after the book has introduced the explicit three-stage prisoner-response structure and completed the first transition.

```text
除了以上描述的反应之外，新囚徒还经常遭受痛苦的感情折磨，他还要抑制这些情感。这种情感首先指他对家乡和家庭的无限思念，有时强烈到足以将其吞噬。其次指对周围一切丑恶行为的厌恶，甚至仅仅是丑陋的外貌都让他感觉厌恶。
```

### p53

```text
大部分囚犯穿上破烂不堪的制服，也就比稻草人优雅一点点。集中营的棚屋之间到处都是粪便，人们越是清除，就越是需要不断地接触这些粪便。新来的犯人被指派去清扫厕所和清除粪便是常事。在道路蜿蜒曲折的运输途中，粪便经常飞溅到囚徒的脸上，他们一旦表现出厌恶，或者用手擦去粪便，就会招致一顿毒打。人的正常反应受到强烈的抑制。
```

### p54

```text
在心理反应的第一阶段，某个囚徒往往不忍目睹别人被罚示众，也不忍目睹泥潭里一排排的囚徒在皮鞭的威慑下来回走几个钟头。几天或几周之后，这种情况就会发生变化。每天拂晓，天色依然灰暗时，该囚徒正和他的小队站在门前排队整装待发。此时，很可能他会听见一声尖叫，紧接着看见一名囚徒被打倒，爬起，再被打倒，再爬起。为什么会这样呢？因为那名被打的囚徒在发烧时没有及时报告医务室，所以被认为干活偷懒，因而招来一顿毒打。
```

### p55

```text
进入心理反应的第二阶段，这个囚徒的眼睛将不再躲避这一切。由于情感已经麻木，他看到什么都只会呆呆地站着不动。除此以外，他顶多盼着自己能借受伤、浮肿或发烧在医务室看病之机，在集中营干两天轻松的活。他看到一个12岁的男孩被带进医务室，这个男孩因为集中营没有他穿着合适的鞋子，被迫在雪地里执勤或在户外干活站了几个小时之后，脚趾被严重冻伤。值班医生用镊子一点点地拽去变黑坏死的部分，而我们这位旁观者的感情却已经麻木，无法真切地感受到厌恶、恐惧或怜悯等情感。进入集中营几周，他不断看到受难者、将死之人和已死之人，对一切已司空见惯，再没什么事情能够打动他了。
```

### p56

```text
有一段时间，我就留在棚屋照料斑疹伤寒病人。他们发着高烧，神志不清，许多还病入膏肓。当某个病人死去后，我也能毫不沮丧地目睹那些会重复发生的情形：即其他囚徒接近体温尚存的尸体，有人夺走死者剩下的土豆泥；有人认为死者的木鞋看起来比自己的要好，就把它换走；有人换走死者的上衣；连只拿到细绳的人都会因此沾沾自喜。
```

### p57

```text
我冷漠地看着发生的一切。最后，再让 “护士”运走这些被掠夺过的尸体。搬尸体时，他随意地拽着尸体的腿，任其尸首在50个斑疹伤寒病人睡的两排木板床间的过道上磕磕碰碰，就这样一直拖着尸体在高低不平的地面上朝门口走去。由于长期缺乏食物，我们的体能已消耗殆尽，哪怕只是通过空旷地带的两级台阶对我们来说都很费力。在几个月的集中营生活里，如果不用手抓住门框，我们几乎无法登上那些约6英寸高的台阶。
```

### p58

```text
“护士”拖着尸体慢慢走到台阶处，他自己先费力地爬上台阶，再转身拖尸体，被拖住的脚带动身躯，最后，伴着奇怪的咯吱声，尸体的头部也颠簸地被拖了上来。
```

### p59

```text
我的床铺在房间的正对面，恰好靠近屋内唯一一扇接近地面的窄窗。当我正用冰冷的双手抱着一碗热腾腾的汤大口喝着，偶尔瞥见窗外那刚刚搬出去的尸体，他直愣愣地瞪着我。两个小时前，我们还在交谈，现在却阴阳两隔。这个念头一闪而过，我继续低头喝汤。
```
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0004` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0004` / `p61@0-87`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0005` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0005` / `p62@148-195`
  - target note: 这时，最痛的不是肉体（这样的惩罚对成人和儿童都一样），而是不公正和不可理喻对心理造成的伤害。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0006` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0006` / `p96@42-154`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0007` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0007` / `p100@42-133`
  - target note: 爱是人类终身追求的最高目标。我理解了诗歌、思想和信仰所传达的伟大秘密的真正含义：拯救人类要通过爱与被爱。我知道世界上一无所有的人只要有片刻的时间思念爱人，那么他就可以领悟幸福的真谛。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0008` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0008` / `p100@217-232`
  - target note: 天使存在于无比美丽的永恒思念中
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0009` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0009` / `p104@68-134`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0010` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0010` / `p108@212-240`
  - target note: 几分钟的寂静后，一名囚犯对另一名感叹道：“世界多美呀！”

Long Span probe markers near this paragraph:
- Probe `2` / `near 40%` / capture `c1-s528`
  - focus: Closes the wife/nature/beauty inner-life sequence before the text turns again, so it can test whether the reader retains spiritual survival rather than only external camp events.
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0011` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0011` / `p114@83-147`
  - target note: 幽默是灵魂保存自我的另一件武器。大家都知道，幽默比人性中的其他任何成分更能够使人漠视困苦，从任何境遇中超脱出来，哪怕只是几秒种。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0012` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0012` / `p116@0-35`
  - target note: 培养幽默感并以一种幽默的态度看待事情，是人在掌握生存艺术时学到的技巧。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0013` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0013` / `p124@0-42`
  - target note: 集中营生活中快乐的匮乏为我们提供了一种消极的幸福——即叔本华所谓 “免于痛苦的自由”
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0014` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0014` / `p132@0-99`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0015` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0015` / `p137@186-215`
...
Long Span probe markers near this paragraph:
- Probe `3` / `near 60%` / capture `c1-s794`
  - focus: Closes the decision-not-to-escape episode, giving a clean semantic checkpoint for active choice, responsibility, and care under captivity.
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0016` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0016` / `p167@95-137`
  - target note: 犯人最终成为什么样的人，仍然取决于他自己内心的决定，而不单单取决于集中营生活的影响。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0017` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0017` / `p167@192-226`
  - target note: 陀思妥耶夫斯基说过：“我只害怕一样——那就是配不上我所受的痛苦。”
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0018` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0018` / `p168@156-214`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0019` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0019` / `p169@101-168`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0020` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0020` / `p178@32-122`
  - target note: 看不到 “临时的存在”何时结束的人，也不可能去追求生活的终极目标。他不再像正常人那样为了将来而生存。因此，他内在生命的这个结构就改变了，我们从生活其他领域所知道的堕落迹象就开始了。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0021` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0021` / `p178@311-328`
  - target note: 在集中营里，一天过得比一个星期慢。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0022` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0022` / `p180@0-28`
  - target note: 看不到未来的人之所以自甘沉沦，是因为他发现自己老在回忆。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0023` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0023` / `p180@53-103`
  - target note: 但剥去当下的现实性就会蕴涵着一个危险，那就是容易忽视积极度过集中营生活的机会，而的确存在这样的机会。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0024` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0024` / `p180@160-185`
  - target note: 正是在极端困苦的环境下，人才有实现精神升华的机会。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0025` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0025` / `p180@185-232`
  - target note: 他们不是把集中营的苦难看做对自身内在力量的考验，而是很不严肃地对待自己的生命，把生命轻易抛弃。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0026` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0026` / `p180@232-265`
  - target note: 他们更愿意闭上眼睛，生活在过去之中。对这些人来说，生命是无意义的。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0027` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0027` / `p182@83-137`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0028` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0028` / `p184@163-214`
  - target note: 斯宾诺莎在《伦理学》中谈到 “作为痛苦的激情，一旦我们对它有了清晰而明确的认识，就不再感到痛苦了”。
...
Long Span probe markers near this paragraph:
- Probe `4` / `near 80%` / capture `c1-s1083`
  - focus: Captures the argument that loss of future orientation weakens the body, just before the text deepens the life-purpose frame.
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0029` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0029` / `p194@35-57`
  - target note: 尼采说过：“知道为什么而活的人，便能生存。”
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0030` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0030` / `p195@45-75`
  - target note: 我们期望生活给予什么并不重要，重要的是生活对我们有什么期望。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0031` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0031` / `p195@138-174`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0032` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0032` / `p196@68-96`
  - target note: “生命”的意义不是某种含糊的东西，而是非常实在和具体的。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0033` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0033` / `p197@65-106`
  - target note: 没有人能够解除你的磨难，替代你的痛苦。你独特的机会就依存于自己承受重负的方式之中。
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0034` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0034` / `p199@0-71`
  - target note: 一旦我们明白了磨难的意义，我们就不再通过无视折磨或心存幻想、虚假乐观等方式去减少或平复在集中营遭受的苦难。经受苦难成了一项我们不能逃避的任务。
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0035` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0035` / `p199@71-106`
  - target note: 我们意识到了苦难中暗藏着的成功机会，诗人称这种机会为“要经受多少磨难啊
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0036` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0036` / `p199@138-203`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0037` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0037` / `p202@57-153`
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0038` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0038` / `p207@205-227`
  - target note: 尼采的话：“那没能杀死我的，会让我更强壮。”
...
Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0039` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0039` / `p210@45-86`
  - target note: 在任何情况下，人的生命都不会没有意义，而且生命的无限意义就包含着苦难、剥夺和死亡。
...
```text
第四，需要说明的是，即使看守里面也有一些可怜我们的人。我被解放时所在集中营的司令就是个很好的例子。等解放以后才发现，那个司令自己曾经出了不少钱从最近的市场给犯人购买药品，[1] 这件事只有本身也是犯人的狱医知道。但也是犯人的囚头儿却比哪个党卫军都狠，他一有机会就殴打其他犯人，而就我所知，那个集中营司令从没对我们动过一根手指头。
```

### p218

Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0040` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0040` / `p218@255-308`
  - target note: 当时我感动得热泪盈眶，不只是因为一块面包，他所给我的还有一份人性，跟礼物相伴的是他温暖的话语和仁慈的表情。

```text
显然，一个人是集中营司令还是犯人，不能说明任何问题。在任何团体里，都能发现人的仁慈，哪怕这个团体整体上应该受到谴责。团体的界限会有交叉，我们不能简单地下结论说哪些人是天使，哪些人是魔鬼。当然，在集中营环境的影响下，如果某个看守或者囚头儿仍能仁慈地对待犯人，那是他了不起的造化。另一方面，如果某个犯人残酷地对待自己的狱友，那他心理的龌龊也达到了让人难以启齿的地步。犯人们对这类缺乏人性的囚头儿尤其痛恨，而对看守表现出来的极小的仁慈却至为感激。我记得有一天，一个监工悄悄给了我一片面包，那一定是他从早饭中省下来的。当时我感动得热泪盈眶，不只是因为一块面包，他所给我的还有一份人性，跟礼物相伴的是他温暖的话语和仁慈的表情。
```
...
Long Span probe markers near this paragraph:
- Probe `5` / `window end` / capture `c1-s1292`
  - focus: Ends the meaningful main-text window before citation-only tail material, so the final snapshot reflects the whole selected chapter rather than footnote residue.
...
```text
不过，对于每个真正得到解放的犯人来说，当他回首集中营的经历时却不再能理解自己是如何活下来的。当所有的事物成为美丽的梦境，真正的解放到来了。因此，当他们觉得集中营的全部经历仅仅是一场噩梦而已时，他们最后的解放也就到来了。
```

### p238

Selective Legibility note targets in this paragraph:
- `huochu_shengming_de_yiyi_private_zh_personal_notes__e0041` / `huochu_shengming_de_yiyi_private_zh__huochu_shengming_de_yiyi_private_zh_personal_notes__e0041` / `p238@0-61`
...
```text
[1] 提起这位党卫军司令，曾经有过一件趣事，与那些犹太犯人对他的态度有关。战争结束的时候，美国军队解放了我们这些犯人，而三个匈牙利籍犹太犯人将那位司令掩藏在了巴伐利亚的丛林中，然后他们找到美军的指挥官 （他正组织抓捕集中营司令），说他们可以帮他找到司令，但有一些条件：美军指挥官必须保证绝不允许任何人伤害司令。过了一会，美军指挥官答应三个犹太人，抓到党卫军司令后保证不许任何人伤害他。美军指挥官不仅信守了诺言，而且那个党卫军司令实际上被官复原职，负责监督从附近村子里收集衣物并向我们发放，而我们当时仍然穿着从奥斯维辛那些没我们幸运、被送到毒气室杀害的犯人身上扒下来的衣服。
