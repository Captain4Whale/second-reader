...
| `Long Span active direction` | `attentional_v2_long_span_vnext_phase1_memory_quality_scale_fix_rejudge_20260425` | `attentional_v2` for Memory Quality; `attentional_v2` vs `iterator_v1` for reaction audit | `phase-1 diagnostic evidence; not formal authority yet` | The active Long Span direction has moved away from `target-centered accumulation v2` and is now defined by `Memory Quality`, `Spontaneous Callback`, and `False Visible Integration`. Phase 1 is implemented through `run_long_span_vnext.py`; the April 25 rejudge fixes Memory Quality scoring scale (`1` low, `5` high) without rereading books, and copies reaction-audit results unchanged from the April 23 source run. This is usable diagnostic evidence, but no formal long-span run has been promoted yet under the new direction. | [methodology](../../../docs/backend-reader-evaluation.md) · [surface index](./long_span/README.md) · [phase-1 aggregate](../../eval/runs/attentional_v2/attentional_v2_long_span_vnext_phase1_memory_quality_scale_fix_rejudge_20260425/summary/aggregate.json) · [phase-1 report](../../eval/runs/attentional_v2/attentional_v2_long_span_vnext_phase1_memory_quality_scale_fix_rejudge_20260425/summary/report.md) · [phase-1 runner](../../eval/attentional_v2/run_long_span_vnext.py) · [archived target-centered design](./long_span/target_centered_accumulation_v2_design.md) |
