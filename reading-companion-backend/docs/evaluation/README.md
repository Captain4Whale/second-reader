...
| `target-centered long-span accumulation v2` | `attentional_v2_accumulation_benchmark_v2_frozen_rejudge_contract_fix_20260422` | `attentional_v2` vs `iterator_v1` | `current formal evidence on frozen seed set` | The April 22 rejudge fixes the Long Span evidence contract so only target-visible mechanism behavior can create score; `attentional_v2` now leads on average quality score (`2.333` vs `1.0`). The April 19 Long Span child is preserved as invalidated diagnostic evidence. | [design](./long_span/target_centered_accumulation_v2_design.md) · [surface index](./long_span/README.md) · [frozen manifest](../../eval/manifests/splits/attentional_v2_accumulation_benchmark_v2_frozen.json) · [aggregate](../../eval/runs/attentional_v2/attentional_v2_accumulation_benchmark_v2_frozen_rejudge_contract_fix_20260422/summary/aggregate.json) · [report](../../eval/runs/attentional_v2/attentional_v2_accumulation_benchmark_v2_frozen_rejudge_contract_fix_20260422/summary/report.md) · [audit](../../eval/runs/attentional_v2/attentional_v2_accumulation_benchmark_v2_frozen_rejudge_contract_fix_20260422/analysis/longspan_rejudge_audit_20260422/README.md) |
